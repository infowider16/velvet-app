...
@section('title', 'Boost Transactions')
@push('styles')
...
<style>
    ...
    div#boost-transaction-table_filter {
        display:none;
    }
</style>
@endpush
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <!--    <i class="fas fa-rocket mr-2"></i> Boost Transactions-->
                    <!--</h1>-->
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Boost</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow-lg border-0">
                        <div class="card-header bg-gradient-boost text-white">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-rocket mr-2"></i>Boost Transaction List
                                </h3>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover table-striped mb-0" id="boost-transaction-table">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th class="border-0">
                                                <i class="fas fa-hourglass-half mr-1"></i>Boost Duration
                                            </th>
                                            <th class="border-0">
...
<script>
    let table = $('#boost-transaction-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('admin.transaction-boost-list') }}",
            data: function(d) {
