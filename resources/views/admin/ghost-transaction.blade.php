...
@section('title', 'Ghost Transactions')
@push('styles')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <!--    <i class="fas fa-ghost mr-2"></i> Ghost Transactions-->
                    <!--</h1>-->
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow-lg border-0">
                        <div class="card-header bg-gradient-ghost text-white">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-ghost mr-2"></i>Ghost Transaction List
                                </h3>
                            </div>
                        </div>
...
<script>
    let table = $('#ghost-transaction-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('admin.transaction-ghost-list') }}",
            data: function(d) {
